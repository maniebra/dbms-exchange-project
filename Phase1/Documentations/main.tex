...
\subsection{حذف \lr{sales\_lists\_id , purchase\_list\_id} از \lr{orders}}
...
از انجایی که دو$(market\_id , is\_sell) \rightarrow (sales\_lists\_id , purchase\_lists\_id)$ دو \lr{non prime attribute} به یک \lr{non prime attribute} دیگر اشاره می‌کند، این دیپندنسی باعث می‌شود که جدول ما سومین فرم نرمال نباشد و ما باید ان را به یک جدول دیگر انتقال بدهیم.
\subsection{حذف \lr{maker\_id , taker\_id} از \lr{trades}}
\section{\lr{index}ها}
