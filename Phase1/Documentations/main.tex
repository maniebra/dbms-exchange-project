...
\\
در مرحله‌ی اول ما دو دیپندسی $taker\_order\_id \rightarrow taker\_id$ و $maker\_order\_id \rightarrow maker\_id$باعث می شوند جدول ما در سومین فرم نرمال قرار نگیرد به دلیل مثال فبلی باید در جداولی دیگر قرار می دهیم که این دو جدول هر دو زیر مجموعه از جدول سفارشات هستند که ما نیازی به ساختن ان ها نداریم.
$$ trades (\underline{trade\_id},date\_placed,fill,wage,value,min\_fill\_remainder,type,market\_id,$$
...
$$F.D = \{trade\_id \rightarrow all\,attribute\}$$
