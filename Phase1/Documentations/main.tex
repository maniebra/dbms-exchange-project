...
\begin{document}
    ...
    \newpage
        ...
        جدول تقسیم وظایف نیز از \hyperlink{https://docs.google.com/spreadsheets/d/1x1Guh4HTWLyG9GTomZEtesp5cjIGez9m9Day3bS_kgM/edit?usp=sharing}{\underline{اینجا}}\footnote{در صورتی که این لینک برای شما کار نمی‌کند، میتوانید از آدرس \\\lr{https://docs.google.com/spreadsheets/d/\\1x1Guh4HTWLyG9GTomZEtesp5cjIGez9m9Day3bS\_kgM/edit?usp=sharing}\\ استفاده نمایید.} قابل مشاهده است.
