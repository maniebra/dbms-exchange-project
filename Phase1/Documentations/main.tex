...
در این بخش ما تمام جداول پایگاه داده‌ی خود را به فرم نرمال در اوردیم و تغیرات نمودار و دستورات ایجاد پایگاه داده را در دو فایل \lr{normalized sqlform Integrated.drawio} و \lr{Normalized Create Tables.sql} در مسیر \lr{Phase2/Normalize Files} قرار دادیم.
...
\subsection{حذف \lr{list\_id} ها از \lr{orders}}
