...
موجودیت صرافی ها یا همان \lr{Brokers}، که دارای صفات گفته شده از جمله شناسه و سایر موارد است. این موجودیت برای ذخیره اطلاعت مربوط به صرافی های ارز دیجیتال می باشد. همچنین به موجودیت فروشگاه ها متصل می باشد که برای هر ارز پایه در صرافی یک فروشگاه وجود دارد و به موجودیت \lr{admin} متصل است که در ان ادمین های هر صرافی مشخص می شوند.
