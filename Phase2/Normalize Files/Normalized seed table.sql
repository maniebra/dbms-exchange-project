...
INSERT INTO orders (is_sell,state,fill,client_id,date,market_id,amount) VALUES
	(TRUE, 'end', 2, 5, '2020-06-08', 1, 100),
	(TRUE, 'end', 6, 6, '2021-06-08', 2, 50),
	(TRUE, 'end', 8, 2, '2021-07-08', 6, 100),
	(TRUE, 'end', 10, 2, '2023-06-08', 3,70),
	(TRUE, 'end', 2, 5, '2020-06-08', 4, 100),
	(TRUE, 'end', 6, 6, '2021-06-08', 5, 50),
	(TRUE, 'fill', 8, 3, '2021-07-08', 5, 100),
	(TRUE, 'fill', 10, 1, '2023-06-08', 5,70),
	
	
	(TRUE, 'end', 2, 3, '2020-06-08', 1, 100),
	(TRUE, 'end', 6, 2, '2021-06-08', 2, 50),
	(TRUE, 'end', 8, 1, '2021-07-08', 6, 100),
	(TRUE, 'end', 10, 5, '2023-06-08', 3,70),
	(TRUE, 'end', 2, 5, '2020-06-08', 7,550),
	(TRUE, 'end', 6, 5, '2021-06-08', 3, 50),
	(TRUE, 'fill', 8, 5, '2021-07-08',3,100),
	(TRUE, 'fill', 10, 3, '2023-06-08', 3,70),
	
	
	
	
	(TRUE, 'end', 2, 5, '2020-06-08', 2, 100),
	(TRUE, 'end', 6, 6, '2021-06-08', 2, 50),
	(TRUE, 'end', 8, 2, '2021-07-08', 2, 100),
	(TRUE, 'end', 10, 2, '2023-06-08', 2,70),
	(TRUE, 'end', 2, 5, '2020-06-08', 2, 100),
	(TRUE, 'end', 6, 6, '2021-06-08', 2, 50),
	(TRUE, 'fill', 8, 3, '2021-07-08', 2, 100),
	(TRUE, 'fill', 10, 1, '2023-06-08', 2,70),
	
	
	(TRUE, 'end', 2, 3, '2020-06-08', 2, 100),
	(TRUE, 'end', 6, 2, '2021-06-08', 2, 50),
	(TRUE, 'end', 8, 1, '2021-07-08', 2, 100),
	(TRUE, 'end', 10, 5, '2023-06-08',2,70),
	(TRUE, 'end', 2, 4, '2020-06-08', 2,100),
	(TRUE, 'end', 6, 5, '2021-06-08', 2, 50),
	(TRUE, 'fill', 8, 5, '2021-07-08',2,100),
	(TRUE, 'fill', 10, 3, '2023-06-08', 2,70);	
...
INSERT INTO p2p (date_placed,fill,wage,value,min_fill_remainder,market_id, taker_order_id,maker_order_id) VALUES 
	('2021-10-08', 100, 2, 20, 100, 1, 9, 1),
	('2022-10-08', 50 , 3, 20, 50, 2, 10, 2),
	('2022-11-08', 100 , 5, 45, 100, 6, 11, 3),
	('2021-11-08', 70, 2, 20, 70, 7, 4, 12);
	

	
INSERT INTO otc (date_placed,fill,wage,value,taker_id,broker_id,admin_id) VALUES
	('2022-09-08', 550, 5, 40, 5 , 1, 3);
